...
class PromptTemplates:
    def __init__(self):
        ...
        self.default_templates = {
            ...
            ### 未来规划提升
            > [分为三个层次展开：学术目标、职业短期规划、职业长期规划，确保每个层次有明确目标和实现路径，并建立层次间的递进关系]

            ### 为何选择目标学校和目标项目
            > [按照顺序，从以下方面进行通用性阐述：目标国家优势（禁止提及具体国家，提及国家时，用"目标国家"代替）、
            目标院校资源优势及学术环境、目标项目与研究方向的匹配度，从而展示申请者选择的合理性]
            ...
            - 每个学术亮点后应紧跟一个具体课程内容或作业项目的详细分析，重点描述学习内容、项目实践和技能应用，严格禁止提及任何分数 
            - 结尾句总结该学术基础与目标专业的联系
            3.研究经历深化和实习经历深化：
            - 严格遵循STAR原则：
            • S(情境)：简述研究/实习的背景和环境
            ...
            ● 在分析成绩单时，关注与申请专业相关的课程内容和项目成果，严格禁止提及任何分数或成绩等级，只分析学习内容和技能应用
